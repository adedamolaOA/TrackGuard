 ...
 */
public class MovementMainAdapter  extends BaseAdapter implements View.OnClickListener {
    private Activity activity;
    private ArrayList data;
    private static LayoutInflater inflater=null;
    public Resources res;
    MovementMainListModel tempValues=null;
    int i=0;

    /*************  CustomAdapter Constructor *****************/
    public MovementMainAdapter(Activity a, ArrayList d,Resources resLocal) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            vi = inflater.inflate(R.layout.movement_folder_list, null);

            /****** View Holder Object to contain tabitem.xml file elements ******/
            Typeface mgFont = Typeface.createFromAsset(res.getAssets(),"fonts/exo_medium.otf");
            holder = new ViewHolder();
            holder.title = (TextView) vi.findViewById(R.id.lblMovementMainDate);
            holder.description =(TextView)vi.findViewById(R.id.lblMovementMainAddress);

            holder.status = (TextView)vi.findViewById(R.id.lblStaus);
            holder.image = (ImageView)vi.findViewById(R.id.imgMovementStatus);
            holder.title.setTypeface(mgFont);
            holder.description.setTypeface(mgFont);
        ...
        if(data.size()<=0)
        {
            holder.description.setText("No Movement Data Found");
        ...
        else
        {
            ...
            tempValues=null;
            tempValues = ( MovementMainListModel ) data.get( position );
    ...
    private class OnItemClickListener  implements View.OnClickListener{
        ...
        public void onClick(View arg0) {
            ...
            MovementMainActivity sct = (MovementMainActivity)activity;
